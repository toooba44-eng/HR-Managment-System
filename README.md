...
> **الحالة:** هيكل البوابات الخمس + التنقّل + التوجيه حسب الدور مكتمل. الميزات المرتبطة بباكند موجود (الموظفون، الحضور، الإجازات، الإدارات، الملف) تعمل بالكامل؛ والميزات الجديدة (الاشتراكات، الفوترة، الرواتب، التوظيف، المصروفات، الدورات، الاستطلاعات…) مُهيّأة كصفحات "قريباً" وتُبنى تباعاً في مراحل لاحقة.
