...
const attendanceCorrectionRoutes = require('./routes/attendance-corrections');
...
const assetRequestRoutes = require('./routes/asset-requests');
...
const compensationRequestRoutes = require('./routes/compensation-requests');
const successionRoutes = require('./routes/succession');
const talentGridRoutes = require('./routes/talent-grid');
...
app.use('/api/talent-grid', talentGridRoutes);
